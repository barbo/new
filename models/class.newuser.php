	...
	public function AddUser()
	{
 		...
 		if($this->status)
		{
			...
			if($emailActivation == "true")
			{
				...
				$activation_message = langu("ACCOUNT_ACTIVATION_MESSAGE",array($websiteUrl,$this->activation_token));
				...
				$this->success = langu("ACCOUNT_REGISTRATION_COMPLETE_TYPE2");
			}
			else
			{
		
				$this->user_active = 1;
				$this->success = langu("ACCOUNT_REGISTRATION_COMPLETE_TYPE1");
			}	
